...
GEOCODE_PROVIDER_TIMEOUT_SECONDS = int(os.getenv("GEOCODE_PROVIDER_TIMEOUT_SECONDS", "5"))
ROUTE_PROVIDER_TIMEOUT_SECONDS = int(os.getenv("ROUTE_PROVIDER_TIMEOUT_SECONDS", "20"))
...
ROUTE_INCLUDE_ALTERNATIVES = os.getenv("ROUTE_INCLUDE_ALTERNATIVES", "false").lower() in ("true", "1", "yes")
ROUTE_MAX_VARIANTS_PER_LEG = int(os.getenv("ROUTE_MAX_VARIANTS_PER_LEG", "3"))
ROUTE_MAX_COMBINED_CANDIDATES = int(os.getenv("ROUTE_MAX_COMBINED_CANDIDATES", "6"))
ROUTE_MAX_RETURNED_OPTIONS = int(os.getenv("ROUTE_MAX_RETURNED_OPTIONS", "2"))
RESOLVE_STOP_POIS_DURING_COMPUTE = os.getenv("RESOLVE_STOP_POIS_DURING_COMPUTE", "false").lower() in ("true", "1", "yes")
TRIP_COMPUTE_ASYNC = os.getenv("TRIP_COMPUTE_ASYNC", "true").lower() in ("true", "1", "yes")
